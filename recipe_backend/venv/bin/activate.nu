...
def-env activate-virtualenv [] {
    ...
    let virtual_env = '/Users/kiryldorakh/projects/SkillFactory_react/F4_recipe_book/recipe_backend/venv'
    let bin = 'bin'
    let path_sep = ':'
...
alias deactivate = source '/Users/kiryldorakh/projects/SkillFactory_react/F4_recipe_book/recipe_backend/venv/bin/deactivate.nu'
